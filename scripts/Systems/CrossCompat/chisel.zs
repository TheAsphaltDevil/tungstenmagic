...
This file contains code for adding blocks to the chisel.

*********************************************************/

//Quark bookshelves into chisel bookshelves groups

mods.chisel.Carving.addVariation("bookshelf_spruce", <quark:custom_bookshelf>);
