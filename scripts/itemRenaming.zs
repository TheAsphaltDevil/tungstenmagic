...
//Renaming Items
<extrautils2:miner>.displayName = "Mechanical Miner(Automatic Breaker)";
<dimdoors:stable_fabric>.displayName = "Singularity";
<dimdoors:world_thread>.displayName = "World Thread";
<minecraft:potion>.withTag({Potion: "extraalchemy:dispel_normal"}).displayName = "Potion of Enchantment Dispelling";
