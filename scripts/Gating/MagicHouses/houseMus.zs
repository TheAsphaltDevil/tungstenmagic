...
var zsItem = VanillaFactory.createItem("cert_hvc");
...
zsItem.itemRightClick = function(stack, world, player, hand) {
    ...
    player.hasGameStage("aevitas")
        ...
        Commands.call("gamestage silentadd @p necromancySpells", player, world, false, true);
        Commands.call("gamestage silentadd @p sorcerySpells", player, world, false, true);
        Commands.call("gamestage silentadd @p discidia", player, world, false, true);
        Commands.call("title @s times 15 120 15", player, world, false, true);
        Commands.call("title @s subtitle {\"text\":\"Proud Musan\"}", player, world, false, true);
