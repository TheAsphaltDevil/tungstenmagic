...
var zsItem = VanillaFactory.createItem("cert_hd");
...
zsItem.itemRightClick = function(stack, world, player, hand) {
    ...
    player.hasGameStage("aevitas")
        ...
        Commands.call("gamestage silentadd @p earthSpells", player, world, false, true);
        Commands.call("gamestage silentadd @p sorcerySpells", player, world, false, true);
        Commands.call("gamestage silentadd @p aevitas", player, world, false, true);
        Commands.call("title @s times 15 120 15", player, world, false, true);
        Commands.call("title @s subtitle {\"text\":\"Proud Vitan\"}", player, world, false, true);
