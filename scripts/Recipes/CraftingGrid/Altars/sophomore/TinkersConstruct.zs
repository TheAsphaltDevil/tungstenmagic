...
(sophomore year) recipes for Tinkers' Construct.
...
val astralworkbenchInputs = [
    [
        <tconstruct:materials>,/*************/<thaumcraft:mind>,
            <tconstruct:materials>,<tconstruct:materials>,<tconstruct:materials>,
            <tconstruct:materials>,<minecraft:cauldron>,<tconstruct:materials>,
            <tconstruct:materials>,<tconstruct:materials>,<tconstruct:materials>,
...
val astralworkbenchNames = [
    "tungstenmagic:shaped/internal/altar/tinkersconstructsophomore1",
    "tungstenmagic:shaped/internal/altar/tinkersconstructsophomore2",
    "tungstenmagic:shaped/internal/altar/tinkersconstructsophomore3",
] as string[];
