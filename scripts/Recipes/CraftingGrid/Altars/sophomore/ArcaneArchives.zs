...
(sophomore year) recipes for Arcane Archives.
...
val astralworkbenchInputs = [
    [
        <arcanearchives:raw_quartz>,/*************/<arcanearchives:raw_quartz>,
            null,null,null,
    ...
    [
        <arcanearchives:raw_quartz>,/*************/<arcanearchives:raw_quartz>,
            <astralsorcery:blockmarble>,<minecraft:glass_pane>,<minecraft:glass_pane>,
            <ore:paneGlass>,<minecraft:crafting_table>,<ore:paneGlass>,
            <arcanearchives:raw_quartz>,<ore:paneGlass>,<arcanearchives:raw_quartz>,
        <arcanearchives:raw_quartz>,/*************/<arcanearchives:raw_quartz>,
    ],
    [
        <arcanearchives:raw_quartz>,/*************/<arcanearchives:raw_quartz>,
...
val astralworkbenchNames = [
    "tungstenmagic:shaped/internal/altar/arcanearvhivessophomore1",
    "tungstenmagic:shaped/internal/altar/arcanearvhivessophomore2",
    "tungstenmagic:shaped/internal/altar/arcanearvhivessophomore3",
    "tungstenmagic:shaped/internal/altar/arcanearvhivessophomore4",
] as string[];
