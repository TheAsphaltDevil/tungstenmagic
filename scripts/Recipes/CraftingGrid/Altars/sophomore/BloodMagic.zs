...
(sophomore year) recipes for Blood Magic.
...
val astralworkbenchInputs = [
    [
        null,/*************/null,
            null,null,null,
            <minecraft:stone>,<bloodmagic:soul_forge>,<minecraft:stone>,
            <minecraft:dye:4>,<minecraft:stone>,<minecraft:dye:4>,
    ...
    [
        null,/*************/null,
            null,null,null,
            <minecraft:stone>,<minecraft:cauldron>,<minecraft:stone>,
            <minecraft:dye:4>,<minecraft:stone>,<minecraft:dye:4>,
        <minecraft:diamond>,/*************/<minecraft:diamond>,
    ],
] as IIngredient[][];
...
val astralworkbenchNames = [
    "tungstenmagic:shaped/internal/altar/boodmagicsophomore1",
    "tungstenmagic:shaped/internal/altar/boodmagicsophomore2",
    "tungstenmagic:shaped/internal/altar/boodmagicsophomore3",
] as string[];
